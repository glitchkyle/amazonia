                          ...
                          <Table size='small'>
                            ...
                            >
                              <TableRow>
                                ...
                                <TableCell>{product.createdAt as unknown as string}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>
                                  <Typography
                                ...
                                <TableCell>{product.updatedAt as unknown as string}</TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                        </TableContainer>
                          ...
                          <Table size='small'>
                            ...
                            >
                              <TableRow>
                                ...
                                <TableCell>{product.seller.createdAt as unknown as string}</TableCell>
                              </TableRow>
                              <TableRow>
                                <TableCell>
                                  <Typography
                                ...
                                <TableCell>{product.seller.updatedAt as unknown as string}</TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
                        </TableContainer>
